...
//
// $URL: https://github.com/CGAL/cgal/blob/v6.1.1/Alpha_wrap_3/include/CGAL/Alpha_wrap_3/internal/Alpha_wrap_3.h $
// $Id: include/CGAL/Alpha_wrap_3/internal/Alpha_wrap_3.h 08b27d3db14 $
...
public:
  // Rebuild the gate queue from current cell labels. Used after inserting
  // Steiner points and re-labeling cells for snapshot reconstruction.
  void rebuild_queue() {
#ifdef CGAL_AW3_USE_SORTED_PRIORITY_QUEUE
    m_queue.clear();
#else
